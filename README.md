...
3. [Обзор](#paragraph1)
    ...
    5. [Локализация и интернационализация](#subparagraph1)
    6. [Логирование](#subparagraph2)
    7. [Фикстуры и база данных](#subparagraph3)
    8. [Front-end](#subparagraph4)


## Описание
В данном проекте реализован прототип интернет-магазина, в котором различные пользователи могут продавать и покупать картинки, звуковые дорожки или текста. Тем самым передавая новому пользователю право на использования в своих целях результат чужого интеллектуального труда.
